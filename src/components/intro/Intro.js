        ...
        <div className="intro" id="intro">
            <div className="left">
                <div className="wrapper">
                    ...
                    <p>Currently, I'm focused on exploring my interests in machine learning, algorithms, and other areas of computer science through my classes and research projects. Some of my hobbies include basketball, hiking, and cooking. Thank you for taking a look at my page.</p>
